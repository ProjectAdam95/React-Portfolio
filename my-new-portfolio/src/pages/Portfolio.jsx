...
function Portfolio() {
  // Array of project details, including title, description, image, and links
  const projects = [
    {
      title: 'Weather API',
    ...
    },
    {
      ...
      image: '/assets/images/TaskBoard.png',
  ...
  return (
    <LayoutWrapper>
      ...
      {/* Grid layout to display each project */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 w-full px-4">
        {projects.map((project, index) => (
          ...
          >
            ...
            {/* Links to deployed app and GitHub repository */}
